...
function setRectangle(gl, x, y, r) {
  ...
  var y1 = y - r;
  var y2 = y + r;
  gl.bufferData(gl.ARRAY_BUFFER, new Float32Array([x1, y1, x2, y1, x1, y2, x1, y2, x2, y1, x2, y2, x, y, r]), gl.STATIC_DRAW);
}

/***/ })

/******/ });
//# sourceMappingURL=drawCircle-bf5d2bc905633c1d611e.js.map